...
// MARK: Methods of PokemonListScreen

class PokemonListScreen: UIView {

  // MARK: Private Properties

  weak var delegate: PokemonListScreenToViewControllerProtocol?
...
extension PokemonListScreen: CodeView {
